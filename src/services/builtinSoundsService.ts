    ...
    return [
      {
        ...
        fileName: "rain.mp3",
        category: "Nature",
        audioFile: "/mesmer/presets/nature/rain.mp3", // Fallback to public files
        icon: rainSvg,
      ...
      },
      {
        ...
        fileName: "ocean.mp3",
        category: "Nature",
        audioFile: "/mesmer/presets/nature/ocean.mp3", // Fallback to public files
        icon: oceanSvg,
      ...
      },
      {
        ...
        fileName: "fire.mp3",
        category: "Nature",
        audioFile: "/mesmer/presets/nature/fire.mp3",
        icon: fireSvg,
      ...
      },
      {
        ...
        category: "Nature",
        audioFile: "/mesmer/presets/nature/crickets.mp3",
        icon: cricketsSvg,
      ...
      },
      {
        ...
        fileName: "wind.mp3",
        category: "Nature",
        audioFile: "/mesmer/presets/nature/wind.mp3",
        icon: windSvg,
      ...
      },
      {
        ...
        fileName: "white.mp3",
        category: "Focus",
        audioFile: "/mesmer/presets/focus/white.mp3",
        icon: starSvg,
      ...
      },
      {
        ...
        fileName: "brown.mp3",
        category: "Focus",
        audioFile: "/mesmer/presets/focus/brown.mp3",
        icon: starSvg,
      ...
      },
      {
        ...
        fileName: "pink.mp3",
        category: "Focus",
        audioFile: "/mesmer/presets/focus/pink.mp3",
        icon: starSvg,
      ...
      },
      {
        ...
        fileName: "cafe.mp3",
        category: "Urban",
        audioFile: "/mesmer/presets/urban/cafe.mp3",
        icon: coffeeSvg,
      ...
      },
      {
        ...
        fileName: "chimes.mp3",
        category: "Urban",
        audioFile: "/mesmer/presets/urban/chimes.mp3",
        icon: chimesSvg,

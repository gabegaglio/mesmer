      ...
      {shouldShow && (
        <motion.div
          ...
          transition={{
            duration: 0.3,
            ease: "easeOut",
            delay: isMediumScreen ? 0 : 0.2, // Faster animation on mobile
          }}
        >
          <MuteButton
            themeMode={themeMode}
          ...
          <button
            ...
            className={`p-3 rounded-xl transition-all duration-200 transform hover:scale-110 cursor-pointer ${getGlassmorphicClasses()}`}
            title="Presets"
          >
            <svg
